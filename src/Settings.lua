-- -----------------------------------------------------------------------------
-- Cooldowns
-- Author:  g4rr3t, kabs12, Noget, OwnLight
-- Created: May 5, 2018
--
-- Settings.lua
-- -----------------------------------------------------------------------------
...
function Cool.Settings.Init()
    ...
    local settingsBreakout = {
        ...
        monster = {
            name = "|cFFD700Monster|r |cFFD700Sets|r",
            data = {default.monster},
            description = {"Select a monster set to customize."},
        },
        arena = {
            name = "|c3333CCArena|r |c3333CCSets|r",
            data = {default.arena},
            description = {"Select a monster set to customize."},
        },
        synergy = {
        ...
        cp = {
            name = "|cDC8375CP|r |cDC8375Passives|r",
            data = {default.cp},
            description = {"Select a cp passive to customize."},
        },
        enchant = {
            name = "|cE100FFEnchants|r",
    ...
    for key, set in pairs(Cool.Data.Sets) do
        ...
        elseif set.procType == "monster" then
            table.insert(settingsBreakout.monster.data, key)
            table.insert(settingsBreakout.monster.description, set.description)
        elseif set.procType == "arena" then
            table.insert(settingsBreakout.arena.data, key)
            table.insert(settingsBreakout.arena.description, set.description)    
