...
function Cool.Initialize(event, addonName)
    ...
    Cool.Tracking.EnableCPsFromPrefs()
    Cool.Tracking.EnableBuffsFromPrefs()
    Cool.Tracking.EnableEnchantsFromPrefs()
    Cool.Tracking.EnableMonstersFromPrefs()
    Cool.Tracking.EnableArenasFromPrefs()
